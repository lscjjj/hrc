package com.cebrains.hrc.core.mutidatasource.aop;

import com.cebrains.hrc.core.mutidatasource.DataSourceContextHolder;
import com.cebrains.hrc.core.mutidatasource.annotion.DataSource;
...
public class MultiSourceExAop implements Ordered {
    ...
    @Pointcut(value = "@annotation(com.cebrains.hrc.core.mutidatasource.annotion.DataSource)")
    private void cut() {
