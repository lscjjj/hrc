package com.cebrains.hrc.generator.engine.config;
...
public class ContextConfig {
    ...
    private String templatePrefixPath = "hrcTemplate/advanced";
    private String projectPath = "D:\\ideaSpace\\hrc";//模板输出的项目目录
    ...
    private String proPackage = "com.cebrains.hrc.admin";
    private String coreBasePackage = "com.cebrains.hrc.core";
    private String modelPackageName = "com.cebrains.hrc.admin.common.persistence.model";        //model的包名
    private String modelMapperPackageName = "com.cebrains.hrc.admin.common.persistence.dao";  //model的dao
