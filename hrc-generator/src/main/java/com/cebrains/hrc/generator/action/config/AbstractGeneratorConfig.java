...
import com.cebrains.hrc.generator.engine.SimpleTemplateEngine;
import com.cebrains.hrc.generator.engine.base.HRCTemplateEngine;
import com.cebrains.hrc.generator.engine.config.ContextConfig;
import com.cebrains.hrc.generator.engine.config.SqlConfig;
...
public abstract class AbstractGeneratorConfig {
    ...
    public void doHRCGeneration() {
        HRCTemplateEngine HRCTemplateEngine = new SimpleTemplateEngine();
        HRCTemplateEngine.setContextConfig(contextConfig);
        sqlConfig.setConnection(dataSourceConfig.getConn());
        HRCTemplateEngine.setSqlConfig(sqlConfig);
        HRCTemplateEngine.setTableInfo(tableInfo);
        HRCTemplateEngine.start();
    }
}
