DROP DATABASE IF EXISTS hrc_flowable;
CREATE DATABASE IF NOT EXISTS hrc_flowable DEFAULT CHARSET utf8 COLLATE utf8_general_ci;

DROP DATABASE IF EXISTS hrc;
CREATE DATABASE IF NOT EXISTS hrc DEFAULT CHARSET utf8 COLLATE utf8_general_ci;
...
-- ----------------------------
INSERT INTO `sys_notice` VALUES ('6', '世界', '10', '欢迎使用HRC管理系统', '2017-01-11 08:53:20', '1');
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES ('1', 'touxiang.jpg', 'admin', 'ecfadcde9305f8891bcfe5a1e28c253e', '8pgby', '张三', '2017-05-05 00:00:00', '2', 'sn93@qq.com', '18200000000', '1', '27', '1', '2016-01-29 08:49:53', '25');
