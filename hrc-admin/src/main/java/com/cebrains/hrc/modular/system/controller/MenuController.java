...
import com.cebrains.hrc.common.constant.dictmap.MenuDict;
...
import com.cebrains.hrc.core.support.BeanKit;
import com.cebrains.hrc.core.util.ToolUtil;
import com.cebrains.hrc.modular.system.dao.MenuDao;
import com.cebrains.hrc.modular.system.service.IMenuService;
import com.cebrains.hrc.modular.system.warpper.MenuWarpper;
...
public class MenuController extends BaseController {
    ...
    public Tip add(@Valid Menu menu, BindingResult result) {
        ...
        if (ToolUtil.isNotEmpty(existedMenuName)) {
            throw new HRCException(BizExceptionEnum.EXISTED_THE_MENU);
        }
    ...
    private void menuSetPcode(@Valid Menu menu) {
        if (ToolUtil.isEmpty(menu.getPcode()) || menu.getPcode().equals("0")) {
            ...
            if (menu.getCode().equals(menu.getPcode())) {
                throw new HRCException(BizExceptionEnum.MENU_PCODE_COINCIDENCE);
            }
