...
import com.cebrains.hrc.common.persistence.dao.DictMapper;
import com.cebrains.hrc.common.persistence.model.Dict;
import com.cebrains.hrc.core.exception.HRCException;
import com.cebrains.hrc.modular.system.dao.DictDao;
import com.cebrains.hrc.modular.system.service.IDictService;
...
import static com.cebrains.hrc.common.constant.factory.MutiStrFactory.*;
...
public class DictServiceImpl implements IDictService {
    ...
    public void addDict(String dictName, String dictValues) {
        ...
        if(dicts != null && dicts.size() > 0){
            throw new HRCException(BizExceptionEnum.DICT_EXISTED);
        }
        ...
        for (Map<String, String> item : items) {
            ...
            try {
                ...
                throw new HRCException(BizExceptionEnum.DICT_MUST_BE_NUMBER);
            }
