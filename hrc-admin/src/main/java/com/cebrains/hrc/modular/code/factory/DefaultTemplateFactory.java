package com.cebrains.hrc.modular.code.factory;


import com.cebrains.hrc.HRCApplication;
import com.cebrains.hrc.core.CoreFlag;
...
public class DefaultTemplateFactory {
    ...
    public static GenQo getDefaultParams(){
        ...
        genQo.setAuthor("frank");
        genQo.setProjectPackage(HRCApplication.class.getPackage().getName());
