...
package com.cebrains.hrc.core.flowable;
 ...
 */
public class HRCDefaultProcessDiagramGenerator implements ProcessDiagramGenerator {
    ...
    public HRCDefaultProcessDiagramGenerator() {
        this(1.0);
    }

    // The instructions on how to draw a certain construct is
    // created statically and stored in a map for performance.
    public HRCDefaultProcessDiagramGenerator(final double scaleFactor) {
        // start event
